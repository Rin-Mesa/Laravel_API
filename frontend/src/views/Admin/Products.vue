              ...
              <tr v-for="product in paginatedProducts" :key="product.id">
                ...
                <td style="text-align: right;">
                  <div class="actions-group">
                    ...
                    <button class="action-btn delete-btn" @click="handleDeleteProduct(product.id, product.name)" title="Delete">
                      <Trash2 :size="16" />
                    </button>
                  </div>
                </td>
        ...
        <div class="pagination-row">
          ...
          <div class="pager-buttons">
            ...
            <button 
              ...
              :key="p" 
              :class="['pager-btn', { active: currentPage === p }]"
              @click="changePage(p)"
            >
              {{ p }}
            </button>
    ...
    <div class="metrics-cards-grid animate-fade-in-up">
      ...
      <div class="card metric-mini-card">
        ...
        <div class="metric-mini-info">
          ...
          <p>{{ lowStockCount + outOfStockCount }} items are currently below safety threshold. Re-order recommended immediately.</p>
        </div>
      </div>
        ...
        <form @submit.prevent="handleSaveProduct" class="modal-form">
          <div class="modal-form-grid">
            ...
            <div class="form-group span-2">
              ...
              <textarea id="p-desc" class="form-input" style="height: 100px; resize: vertical;" v-model="formDescription"></textarea>
            </div>
            ...
            <div class="form-group span-2">
              ...
              <div class="image-upload-zone">
                ...
                <div v-if="formImagePreview" class="image-preview-box">
                  ...
                  <button type="button" class="remove-preview-btn" @click="formImageFile = null; formImagePreview = null">
                    Remove
                  </button>
                </div>
...
.orange-dot { background-color: var(--warning); }
